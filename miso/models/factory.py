...
def generate(tp: TrainingParameters):
    ...
    if tp.cnn_type.startswith("base_cyclic"):
    ...
    # ResNet Cyclic
    elif tp.cnn_type.startswith("resnet_cyclic"):
        blocks = int(math.log2(tp.img_shape[0]) - 2)
    ...
    # EfficientNet
        ...
        if tp.cnn_type.lower() == "efficientnetb0":
            model_fn = EfficientNetB0
        elif tp.cnn_type.lower() == "efficientnetb1":
            model_fn = EfficientNetB1
        elif tp.cnn_type.lower() == "efficientnetb2":
            model_fn = EfficientNetB2
        elif tp.cnn_type.lower() == "efficientnetb3":
            model_fn = EfficientNetB3
        elif tp.cnn_type.lower() == "efficientnetb4":
            model_fn = EfficientNetB4
        elif tp.cnn_type.lower() == "efficientnetb5":
            model_fn = EfficientNetB5
        elif tp.cnn_type.lower() == "efficientnetb6":
            model_fn = EfficientNetB6
        elif tp.cnn_type.lower() == "efficientnetb7":
    ...
    elif tp.cnn_type.endswith('tl'):
        model_head, model_tail = generate_tl(tp.cnn_type, tp.num_classes, tp.img_shape)
    ...
    # Uses normal keras
        ...
        classifier, preprocess_input = Classifiers.get(tp.cnn_type)
