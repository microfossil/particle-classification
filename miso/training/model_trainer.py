...
from miso.models.resnet50_tl import resnet50_transfer_learning_head
...
def train_image_classification_model(params: dict, data_source: DataSource = None):
    ...
    if cnn_type == 'resnet50_tl':
        ...
        model_tl = resnet50_transfer_learning_head(input_shape=(img_height, img_width, img_channels), nb_classes=data_source.num_classes)
        model_dense = transfer_learning_dense_layers(data_source.num_classes)
        ...
        #                  weights='imagenet',
        #                  pooling='avg')(x)
        #     outputs = transfer_learning_dense_layers(data_source.num_classes)(x)
